                                    ...
                                    <form id="frm-request">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="division" id="seldivision" class="form-control" onchange="select_location()" >
                                                    <option></option>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div>
                                                    <select name="location" id="sellocation" class="form-control" >
                                                        <option></option>
                                            ...
                                            <label for="selunit">Unit</label>
                                                <div>
                                                    <select name="unit" id="selunit" class="form-control" >
                                                        <option></option>
                                                    </select>
                                                </div>
                                            </div>
