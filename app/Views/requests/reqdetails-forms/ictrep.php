<div class="row">
    ...
    <div class="col-md-6">
        <span class="font-weight-semibold text-dark">Item/Property Code or Serial Number</span>
        <p><?=$reqdetails['itemcode']?></p>
    </div>
    <div class="col-md-6">
        <span class="font-weight-semibold text-dark">Location</span>
        <p><?=$reqdetails['xlocation']?></p>
    </div>
    <div class="col-md-12">
        <div class="m-t-20">
            <span class="font-weight-semibold text-dark">Description of the Problem</span>
            <div class="m-t-10">
