                ...
                <table class="table table-hover e-commerce-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded" src="<?=base_url('assets/images/others/thumb-9.jpg'); ?>" style="max-width: 60px" alt="">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded" src="<?=base_url('assets/images/others/thumb-10.jpg'); ?>" style="max-width: 60px" alt="">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded" src="<?=base_url('assets/images/others/thumb-11.jpg'); ?>" style="max-width: 60px" alt="">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded" src="<?=base_url('assets/images/others/thumb-12.jpg'); ?>" style="max-width: 60px" alt="">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded" src="<?=base_url('assets/images/others/thumb-13.jpg'); ?>" style="max-width: 60px" alt="">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded" src="<?=base_url('assets/images/others/thumb-14.jpg'); ?>" style="max-width: 60px" alt="">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded" src="<?=base_url('assets/images/others/thumb-15.jpg'); ?>" style="max-width: 60px" alt="">
